...
Name2Labels defaultLabels() {
    ...
    labels[QObject::tr("\"Fairway\" трава")             ] = LabelInfo(QObject::tr("\"Fairway\" трава"), "void",  9, 9, QColor(146, 243, 146));
    labels[QObject::tr("\"Raw\" трава")             ] = LabelInfo(QObject::tr("\"Raw\" трава"), "void",   10, 10, QColor(10, 250, 30));
    ...
    labels[QObject::tr("\"Green\" трава")             ] = LabelInfo(QObject::tr("\"Green\" трава"), "void",   16, 16, QColor(0, 255, 127));
